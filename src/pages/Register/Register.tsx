...
const Register = () => {
  ...
  return (
    <section>
      <motion.div
        id="regbg"
        className="bg-[#f89216] min-h-screen flex items-center justify-center py-20 "
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
          ...
          >
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="w-max mx-auto flex justify-center">
                <motion.button
                  type="submit"
                  className="w-full bg-[#333333] text-white font-bold py-3 px-20 rounded-full hover:bg-[#30AC57] transition-colors focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2"
